...
**Hinweis**  Wenn Sie andere Entwurfsoberflächen als den XML-Editor verwenden, geben XAML-Designer oft Sortierungskonventionen vor. Sie können diesen XAML-Code später jedoch beliebig bearbeiten, die Reihenfolge der Attribute ändern oder neue Attribute hinzufügen.
...
**Hinweis**  Klicken Sie in Referenzthemen für eine API, die XAML und Enumerationen verwendet, auf den Link zu dem Enumerationstyp im Abschnitt **Property value** unter **Syntax**. So gelangen Sie auf die Enumerationsseite, auf der Sie die benannten Konstanten für diese Enumeration ermitteln können.
