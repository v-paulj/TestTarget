...
-   (Optional) Erstellen Sie Eigenschaftenmetadaten für die Abhängigkeitseigenschaft. Sie benötigen Eigenschaftenmetadaten nur, wenn Sie das Verhalten „Eigenschaft geändert“ oder einen metadatenbasierten Standardwert haben möchten, der durch den Aufruf von [**ClearValue**](https://msdn.microsoft.com/library/windows/apps/br242357) wiederhergestellt werden kann.
...
-   Definieren Sie einen [**DependencyProperty**](https://msdn.microsoft.com/library/windows/apps/br242362)-Bezeichner als **public****static****readonly**-Eigenschaftenmember des Besitzertyps.
