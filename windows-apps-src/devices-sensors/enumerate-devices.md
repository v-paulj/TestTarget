...
Wenn Sie diese beiden Informationselemente beibehalten, können Sie das **DeviceInformation**-Objekt erneut erstellen, nachdem es verloren gegangen ist, indem Sie diese Informationen für [**CreateFromIdAsync**](https://msdn.microsoft.com/library/windows/apps/windows.devices.enumeration.deviceinformation.createfromidasync_907774063) bereitstellen. Auf diese Weise können Sie Benutzereinstellungen für ein Gerät speichern, das in Ihre App integriert wird. Beispiel
