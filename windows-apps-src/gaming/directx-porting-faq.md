...
# DirectX11 – Häufig gestellte Fragen zur Portierung
...
## Wofür dient der neue Gerätekontext? Muss ich mein Direct3D9-Gerät durch das Direct3D11-Gerät ersetzen, den Gerätekontext oder beides?
...
##  Wie verwalte ich Codepfade für den Desktop und den WindowsStore?
...
## Kann ich meinen Desktopcode vor der Umstellung von Effects auf DirectX11 aktualisieren?
...
##  Gibt es einen Pfad für die Portierung meines DirectX8-Spiels zu UWP?
...
##  Kann ich mein DirectX10- oder 11-Spiel zu UWP portieren?
...
## Mein Spiel rendert mit Multithreading und/oder verzögertem Rendering. Was muss ich in diesem Zusammenhang bei Direct3D11 beachten?
...
## Wo finde ich weitere Informationen zur programmierbaren Pipeline seit Direct3D9?
...
##  Was ist das Direct3D11-Äquivalent für die *x*-Funktion?
