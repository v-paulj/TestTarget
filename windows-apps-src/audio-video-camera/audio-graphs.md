...
Das [**FrameInputNode.QuantumStarted**](https://msdn.microsoft.com/library/windows/apps/dn958507)-Ereignis wird ausgelöst, wenn das Audiodiagramm bereit ist, die Verarbeitung des nächsten Quantums von Audiodaten zu verarbeiten. Sie stellen die benutzerdefinierten generierten Audiodaten vom Handler an dieses Ereignis bereit.
...
-   Alle Audioeffekte implementieren die [**IAudioEffectDefinition**](https://msdn.microsoft.com/library/windows/apps/dn608044)-Schnittstelle. Mit jedem Knoten wird eine **EffectDefinitions**-Eigenschaft verfügbar, die die Liste der auf diesen Knoten angewendeten Effekten darstellt. Fügen Sie einen Effekt hinzu, indem Sie sein Definitionsobjekt zu der Liste hinzufügen.
