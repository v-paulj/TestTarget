...
-   [**SingleUse**](https://msdn.microsoft.com/library/windows/apps/dn263732) – Entfernt den Geofence-Bereich, nachdem alle Zustände, auf die der Geofence-Bereich überwacht wird, erfüllt wurden.
...
-   **Standort für dieses Gerät ...** ist **aktiviert** (gilt nicht in Windows 10 Mobile)
