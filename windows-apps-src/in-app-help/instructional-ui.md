...
## <span id="when_to_use_instructional_ui"></span><span id="WHEN_TO_USE_INSTRUCTIONAL_UI"></span>Gründe für die Verwendung der Benutzeroberfläche mit Anleitungen
...
## <span id="writing_instructional_ui"></span><span id="WRITING_INSTRUCTIONAL_UI"></span>Prinzipien beim Entwerfen von Benutzeroberflächen mit Anleitungen
...
-   **Grundlegende Funktionen:** Wenn Benutzer Anleitungen zum Verwenden Ihrer App benötigen, sollten Sie das App-Design intuitiver gestalten.
-   **Offensichtliche Funktionen:** Wenn eine Funktion ohne Anleitung für einen Benutzer offensichtlich ist, wird ihm eine Benutzeroberfläche mit Anleitungen nur im Weg stehen.
-   **Komplexe Funktionen:** Benutzeroberflächen mit Anleitungen müssen präzise sein. Benutzer, für die komplexe Funktionen von Interesse sind, sind in der Regel bereit, selbst nach Anleitungen zu suchen.
...
-   **Wichtige Informationen verschleiern:** Benutzeroberflächen mit Anleitungen sollten nie anderen Funktionen Ihrer App im Weg stehen.
...
-   **Informationen wiederholt anzeigen:** Belästigen Sie die Benutzer nicht erneut mit Anleitungen auf der Benutzeroberfläche, wenn sie diese bereits einmal ignoriert haben. Das Hinzufügen einer Einstellung, mit der Anleitungen erneut auf der Benutzeroberfläche angezeigt werden können, ist die bessere Lösung.
