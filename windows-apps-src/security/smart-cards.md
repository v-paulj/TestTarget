...
3.  [**VerifyResponseAsync**](https://msdn.microsoft.com/library/windows/apps/dn297627) gibt den Wert **true** zurück, wenn die Authentifizierung erfolgreich ist.
