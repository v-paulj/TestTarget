---
description: Wenn Sie im Windows Dev Center-Dashboard eine neue App erstellen, muss der App-Name im gesamten Store eindeutig sein. In diesem Thema wird erläutert, wie Sie Namen reservieren, und es enthält einige Vorschläge zur Wahl aussagekräftiger App-Namen.
title: App-Erstellung durch Reservierung eines neuen Namens
...
Wenn Sie im Windows Dev Center-Dashboard eine neue App erstellen, muss der App-Name im gesamten Store eindeutig sein. In diesem Thema wird erläutert, wie Sie Namen reservieren, und es enthält einige Vorschläge zur [Wahl aussagekräftiger App-Namen](#choosing-your-app-s-name).
