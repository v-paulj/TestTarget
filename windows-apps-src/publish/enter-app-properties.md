...
Ist dies der Fall, wird im Windows Store versucht festzustellen, ob das Gerät eines Kunden das ausgewählte Hardwarefeature unterstützt. Wenn festgestellt wird, dass dies nicht der Fall ist, wird dem Kunden eine Warnung angezeigt, dass er eine App herunterladen möchte, für die eine bevorzugte Hardware deklariert ist. Kunden mit Windows10-Geräten werden darüber hinaus die ausgewählten Features im Abschnitt **Hardwareanforderungen** des Store-Eintrags für Ihre App angezeigt.
...
> 
            **Wichtig**  Mit Ausnahme von **Touchscreen** werden diese Warnungen nur Kunden mit Windows10-Geräten angezeigt, die die ausgewählten Features nicht besitzen.
