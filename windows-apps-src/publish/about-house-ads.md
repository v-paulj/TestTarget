...
Zum Einrichten von Eigenwerbung müssen Sie beim [Erstellen einer Anzeigenkampagne](create-an-ad-campaign-for-your-app.md) den Kampagnentyp**** **Kostenlose Kampagne mit eigener Werbung** auswählen. Die Anzeige kann daraufhin in jeder Ihrer Apps angezeigt werden, die die folgenden Kriterien erfüllt:
...
> **Hinweis**  Ein einzelner Endbenutzer sieht eine bestimmte Eigenwerbung maximal fünfmal am Tag.
