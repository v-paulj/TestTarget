---
Description: Dieser Artikel bietet eine Übersicht über die Konzepte in Bezug auf das Entwerfen von barrierefreier Software für universelle Windows-Plattform (UWP)-Apps.
title: Entwerfen von inklusiver Software
ms.assetid: A6393A57-53F2-4F06-89AF-0D806FD76DB0
label: Designing inclusive software
template: detail.hbs
---

Entwerfen von inklusiver Software
============================
...
Diese neue Designphilosophie wird als universelles Design oder inklusives Design bezeichnet. Unser Ziel ist es, Software von Grund auf für alle Arten von Benutzern zu entwickeln. Dies steht im Gegensatz zu der Auffassung, dass Eingabehilfen erst am Ende des Entwicklungsprozesses erstellt werden, um die Anforderungen einer kleinen Gruppe von Benutzern zu erfüllen.

„Wir definieren eine Behinderung als den Konflikt zwischen den Anforderungen einer einzelnen Person und dem angebotenen Dienst, dem angebotenen Produkt oder der angebotenen Umgebung. Jeder Benutzer kann eine Behinderung erleiden. Es ist eine allgemeine menschliche Erfahrung, ausgeschlossen zu werden.“  
   - aus dem [Inclusive](https://www.microsoft.com/en-us/design/inclusive)-Video  

Mithilfe des inklusiven Designs werden bessere Produkte für alle erstellt. Es geht darum, die gesamte Bandbreite der menschlichen Vielfalt zu berücksichtigen.

Denken Sie beispielsweise an die Bordsteinabsenkungen, die Sie jetzt in den Kreuzungsbereichen der meisten Bürgersteige finden. Diese sind eindeutig zur Verwendung durch Rollstuhlfahrer bestimmt. Mittlerweile werden sie jedoch von beinahe allen verwendet, einschließlich Personen mit Kinderwagen, Radfahrern, Skateboardern und sogar Fußgängern, da die Bordsteinabsenkungen vorhanden und bequemer sind. Fernbedienungen könnten als Hilfstechnologie (Assistive Technology, AT) für Personen mit körperlichen Einschränkungen betrachtet werden. Es ist heute jedoch fast unmöglich, einen Fernseher ohne Fernbedienung zu kaufen. Bevor Kinder lernen, ihre Schuhe zuzubinden, können sie Schuhe mit Klettriemen tragen. Dies sind nur einige Beispiele, die als inklusives Design betrachtet werden könnten.
...
**Make it personal (Personalisierung)**: Als Nächstes stellen wir uns der Herausforderung, eine emotionale Verbindung herzustellen. Zwischenmenschliche Interaktionen können bessere Interaktionen zwischen Menschen und Technologien inspirieren. Die einzigartigen Umstände eines Menschen können ein Design für alle Menschen verbessern. Das Ergebnis ist eine Umgebung, die wirkt, als wäre sie nur für eine einzige Person entwickelt worden.
...
1. Personen, die diese aufgrund von Behinderungen oder Beeinträchtigungen, altersbezogenen Umständen oder vorübergehenden Umständen (beispielsweise aufgrund eines gebrochenen Arms) benötigen  
...
## Anleitungen – Designschritte für die Praxis ##
In diesem Abschnitt werden Designschritte für die Praxis beschrieben, die Sie bei der Implementierung des inklusiven Designs in Ihrer App beachten sollten.  
...
### Sprechen Sie mit Menschen mit spezifischen Bedürfnissen ###
...
Wenn Sie das Framework ausgewählt haben, sollten Sie eine logische Hierarchie entwerfen, um Ihre Steuerelemente zu planen. Die logische Hierarchie Ihrer App enthält das Layout und die Aktivierreihenfolge der Steuerelemente. Wenn Programme für Hilfstechnologien (Assistive Technology, AT) wie die Sprachausgabe Ihre Benutzeroberfläche lesen, ist eine visuelle Darstellung nicht ausreichend. Sie müssen eine programmbasierte Alternative bereitstellen, die für die Benutzer strukturell sinnvoll ist. Eine logische Hierarchie kann Ihnen dabei helfen. Dies ist eine Möglichkeit, das Layout Ihrer Benutzeroberfläche zu untersuchen und die einzelnen Elemente so zu strukturieren, dass Benutzer sie verstehen können. Eine logische Hierarchie wird hauptsächlich zu folgenden Zwecken verwendet:  
...
#### Einstellungen für Systemschriftarten ####
...
5.  Implementieren Sie Ihr Design unter Nutzung des Microsoft-Hubs für die barrierefreie Entwicklung und der Spezifikationen Ihres Frameworks in Bezug auf Barrierefreiheit als Referenzpunkten.  
...
* [Engineering Software for Accessibility (Entwickeln von barrierefreier Software)](https://www.microsoft.com/en-us/download/details.aspx?id=19262)
