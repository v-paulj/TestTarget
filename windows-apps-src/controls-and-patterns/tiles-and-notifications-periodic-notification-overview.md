...
Regelmäßige Benachrichtigungen – auch bezeichnet als abgerufene Benachrichtigungen – aktualisieren Kacheln und Signale in festgelegten Intervallen, indem sie Inhalte aus einem Cloud-Dienst herunterladen. Zur Verwendung von regelmäßigen Benachrichtigungen muss Ihr Client-App-Code zwei Informationen bereitstellen:
...
### <span id="Automatic_retry_behavior"></span><span id="automatic_retry_behavior"></span><span id="AUTOMATIC_RETRY_BEHAVIOR"></span>Verhalten der automatischen Wiederholung
