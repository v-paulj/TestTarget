...
description: In diesem Thema wird eine Fallstudie für das Portieren einer sehr einfachen Windows Phone Silverlight-App auf eine UWP (Universelle Windows-Plattform)-App für Windows 10 vorgestellt.
