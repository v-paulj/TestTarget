...
Besitzen Sie ein Windows10-Projekt, das Sie mit Microsoft Visual Studio2015 RC erstellt haben, finden Sie weitere Informationen unter [Aktualisieren Ihres UWP-Projekts von der RC-Version auf die RTM-Version von Microsoft Visual Studio 2015](update-your-visual-studio-2015-rc-project-to-rtm.md).
