# [Erste Schritte mit der universellen Windows-Plattform](https://developer.microsoft.com/en-us/windows/getstarted)
...
# [Design und UI](https://developer.microsoft.com/en-us/windows/design)
...
## [Stil](https://developer.microsoft.com/windows/design/style)
...
## [Steuerelemente und Muster](https://developer.microsoft.com/windows/design/controls-patterns)
...
### [Aktive Zeichenbereiche](controls-and-patterns/active-canvas.md)
...
### [Suchen](controls-and-patterns/search.md)
...
### [Registerkarten und Pivot](controls-and-patterns/tabs-pivot.md)
### [Text](controls-and-patterns/text-controls.md)
#### [Schriftarten](controls-and-patterns/fonts.md)
...
#### [Segoe MDL2-Symbole](controls-and-patterns/segoe-ui-symbol-font.md)
...
## [Eingaben und Geräte](https://developer.microsoft.com/windows/design/inputs-devices)
...
## [Nutzbarkeit](https://developer.microsoft.com/windows/design/usability)
...
### [Zugriff im Benutzermodus aktivieren](devices-sensors/enable-usermode-access.md)
...
#### [3D-Drucken in der App](devices-sensors/3d-print-from-app.md)
...
### [Unternehmensdatenschutz (EDP)](enterprise/edp-hub.md)
...
###### [Vergleichen von OpenGL ES 2.0-Puffern, -uniform-Elementen und -Vertexattributen mit Direct3D](gaming/porting-uniforms-and-attributes.md)
###### [Vergleich der OpenGL ES 2.0-Shaderpipeline mit Direct3D](gaming/change-your-shader-loading-code.md)
##### [Exemplarische Vorgehensweise: Beispiele für die Portierung von OpenGL ES 2.0](gaming/walkthrough-sample-ports-from-opengl-es-2-0.md)
###### [Portieren eines einfachen OpenGL ES 2.0-Renderers zu Direct3D 11,1](gaming/port-a-simple-opengl-es-2-0-renderer-to-directx-11-1.md)
####### [Shaderobjekte portieren](gaming/port-the-shader-config.md)
####### [Vertexpuffer und -Daten portieren](gaming/port-the-vertex-buffers-and-data-config.md)
####### [GLSL portieren](gaming/port-the-glsl.md)
####### [Auf den Bildschirm zeichnen](gaming/draw-to-the-screen.md)
...
### [Entwurfsleitfaden für Karten](maps-and-location/controls-map.md)
...
### [Einführung in Xbox One-Tools](xbox-apps/introduction-to-xbox-tools.md)
...
##### [Eigenschaftspfadsyntax](xaml-platform/property-path-syntax.md)
...
## [Dienste](https://developer.microsoft.com/en-us/windows/develop/microsoft-services)
...
# [Veröffentlichen von Windows-Apps](https://developer.microsoft.com/en-us/windows/publish)
...
## [Richtlinien und Verhaltensregeln für den Store](https://msdn.microsoft.com/en-us/library/windows/apps/dn764939.aspx)
...
### [Kriterien für die Auffindbarkeit von Apps](https://msdn.microsoft.com/en-us/library/windows/apps/mt652261.aspx)
