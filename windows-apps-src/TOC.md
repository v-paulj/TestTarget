...
###### [Zeichnen auf dem Bildschirm](gaming/draw-to-the-screen.md)
...
#### [Auswählen und Speichern von Tönen mit dem URI-Schema „ms-tonepicker“](launch-resume/launch-ringtone-picker.md)
...
###### [Aktualisieren einer Flight-Paketübermittlung](monetize/update-a-flight-submission.md)
...
##### [Melden von Verbrauchsprodukten als abgewickelt](monetize/report-consumable-products-as-fulfilled.md)
...
## [Portieren von Apps zu Windows 10](porting/index.md)
...
### [Wechseln von Windows Desktop zur UWP](porting/desktop-to-uwp-root.md)
#### [Desktop App Converter](porting/desktop-to-uwp-run-desktop-app-converter.md)
#### [Manuelles Konvertieren Ihrer Windows-Desktop-App zur UWP](porting/desktop-to-uwp-manual-conversion.md)
