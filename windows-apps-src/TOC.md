...
## [Neuigkeiten in Windows für Entwickler](whats-new/windows-10-sdk-preview.md)
### [Neuigkeiten in Windows10, Version1511](whats-new/windows-10-version-1511.md)
### [Neuigkeiten in Windows10 RTM](whats-new/windows-10-rtm.md)
...
### [Menüs, Dialogfelder und Popups](controls-and-patterns/dialogs-popups-menus.md)
...
### [Kacheln, Badges und Benachrichtigungen](controls-and-patterns/tiles-badges-notifications.md)
...
### [Schützen von zwischen Apps übertragenen Unternehmensdaten mithilfe von EDP](app-to-app/use-edp-to-protect-enterprise-data-transferred-between-apps.md)
...
### [Entity Framework7 mit SQLite für C#-Apps](data-access/entity-framework-7-with-sqlite-for-csharp-apps.md)
...
### [Unternehmensdatenschutz (Enterprise Data Protection, EDP)](enterprise/edp-hub.md)
...
### [Schützen von Dateien mithilfe des Unternehmensdatenschutzes (EDP)](files/protect-your-enterprise-data-with-edp.md)
### [Schützen von Datenströmen und Puffern mithilfe des Unternehmensdatenschutzes (Enterprise Data Protection, EDP)](files/use-edp-to-protect-streams-and-buffers.md)
### [Zugreifen auf Inhalte in der Heimnetzgruppe](files/quickstart-accessing-homegroup-content.md)
...
### [Reduzieren der Latenz mit DXGI1.3-Swapchains](gaming/reduce-latency-with-dxgi-1-3-swap-chains.md)
...
#### [Portieren von DirectX9 zur universellen Windows-Plattform](gaming/porting-your-directx-9-game-to-windows-store.md)
##### [Wechseln von DirectX9 zu DirectX11.1 und zur Universellen Windows-Plattform](gaming/porting-considerations.md)
###### [Planen der DirectX-Portierung](gaming/plan-your-directx-port.md)
###### [Wichtige Änderungen beim Wechsel von Direct3D9 zu Direct3D11.1](gaming/understand-direct3d-11-1-concepts.md)
###### [Zuordnung von DirectX9-Funktionen zu DirectX11,1-APIs](gaming/feature-mapping.md)
##### [Exemplarische Vorgehensweise: Portieren einer einfachen Direct3D9-App zu DirectX11.1 und zur Universellen Windows-Plattform](gaming/walkthrough--simple-port-from-direct3d-9-to-11-1.md)
...
##### [Exemplarische Vorgehensweise: Implementieren von Schattenvolumen mit Tiefenpuffern in Direct3D11](gaming/implementing-depth-buffers-for-shadow-mapping.md)
...
##### [DirectX11.1 – Häufig gestellte Fragen zur Portierung](gaming/directx-porting-faq.md)
#### [Portieren von OpenGL ES 2.0 zu Direct3D 11.1](gaming/port-from-opengl-es-2-0-to-directx-11-1.md)
##### [Zuordnen von OpenGLES2.0 zu Direct3D11,1](gaming/map-concepts-and-infrastructure.md)
###### [Planen der Portierung von OpenGLES2.0 zu Direct3D](gaming/compare-opengl-es-2-0-api-design-to-directx.md)
###### [Vergleichen des EGL-Codes mit DXGI und Direct3D](gaming/moving-from-egl-to-dxgi.md)
###### [Vergleichen von OpenGLES2.0-Puffern, uniform-Variablen und Vertexattributen mit Direct3D](gaming/porting-uniforms-and-attributes.md)
###### [Vergleichen der OpenGLES2.0-Shaderpipeline mit Direct3D](gaming/change-your-shader-loading-code.md)
##### [So wird's gemacht: Portieren eines einfachen OpenGLES2.0-Renderers zu Direct3D11.1](gaming/port-a-simple-opengl-es-2-0-renderer-to-directx-11-1.md)
...
##### [OpenGLES2.0 zu Direct3D11.1 – Referenz](gaming/opengl-es-2-0-to-directx-11-1-reference.md)
...
### [Einrichten von Geofence-Bereichen](maps-and-location/set-up-a-geofence.md)
### [Entwurfsleitlinie für Geofencing](maps-and-location/guidelines-for-geofencing.md)
## [Gewinnbringende Nutzung Ihrer App und Kundenbindung](monetize/index.md)
### [Ausschließen oder Beschränken von Features in einer Testversion](monetize/exclude-or-limit-features-in-a-trial-version-of-your-app.md)
### [Unterstützen von In-App-Produktkäufen](monetize/enable-in-app-product-purchases.md)
...
### [Markieren von Netzwerkverbindungen mit EDP-Identität](networking/tagging_network_connections_with_edp_identity.md)
...
#### [MicrosoftPassport und WindowsHello](security/microsoft-passport.md)
...
## [UWP auf XboxOne](xbox-apps/index.md)
...
#### [Deaktivieren der Skalierung](xbox-apps/disable-scaling.md)
#### [Deaktivieren des Overscans](xbox-apps/turn-off-overscan.md)
...
### [Microsoft Advertising-Zahlungsprozess](publish/microsoft-advertising-payment-process.md)
