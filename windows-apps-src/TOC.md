...
### [Bereitstellen von Social Media-Feeds in der Kontakte-App](contacts-and-calendar/integrating-social-feeds-into-contact-cards.md)
...
#### [Freier Speicher, wenn Ihre App in den Hintergrund verschoben wird](launch-resume/reduce-memory-usage.md)
### [Verbundene Apps und Geräte](launch-resume/connected-apps-and-devices.md)
#### [Ermitteln von Remotegeräten](launch-resume/discover-connected-devices.md)
...
### [Behandeln der Verknüpfung zwischen Web und App mit App-URI-Handlern](launch-resume/web-to-app-linking.md)
...
#### [Erstellen und Registrieren einer in einem separaten Prozess ausgeführten Hintergrundaufgabe](launch-resume/create-and-register-a-background-task.md)
#### [Erstellen und Registrieren einer in einem Einzelprozess ausgeführten Hintergrundaufgabe](launch-resume/create-and-register-a-singleprocess-background-task.md)
#### [Umwandeln einer aus mehreren Prozessen bestehenden Hintergrundaufgabe in eine Einzelprozess-Hintergrundaufgabe](launch-resume/convert-multiple-process-background-task.md)
...
### [Kommunikation mit einem App-Remotedienst](launch-resume/communicate-with-a-remote-app-service.md)
### [Konvertieren eines App-Diensts für die Ausführung im gleichen Prozess wie die Host-App](launch-resume/convert-app-service-single-process.md)
...
#### [Aktivieren von In-App-Einkäufen von Apps und Add-Ons](monetize/enable-in-app-purchases-of-apps-and-add-ons.md)
...
#### [Erstellen eines Projekts und Festlegen von Remotevariablen im Dev Center-Dashboard](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
...
#### [Unterstützte UWP-APIs für konvertierte Desktop-Apps](porting/desktop-to-uwp-supported-api.md)
