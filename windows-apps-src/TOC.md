# [Erste Schritte mit der universellen Windows-Plattform](https://dev.windows.com/en-us/getstarted)
...
# [Design und UI](https://dev.windows.com/en-us/design)
...
## [Stil](https://dev.windows.com/design/style)
...
## [Steuerelemente und Muster](https://dev.windows.com/design/controls-patterns)
...
### [Aktive Canvas](controls-and-patterns/active-canvas.md)
...
## [Eingaben und Geräte](https://dev.windows.com/design/inputs-devices)
...
#### [Interaktionen von Gamepad und Fernbedienung](input-and-devices/gamepad-and-remote-interactions.md)
...
## [Nutzbarkeit](https://dev.windows.com/design/usability)
...
## [Microsoft-Entwurfssprache](https://dev.windows.com/design/microsoft-design-language)
## [Downloads](https://dev.windows.com/design/assets)
# [Entwickeln von Windows-Apps](http://dev.windows.com/develop)
...
### [Audiogeräteinformationseigenschaften](audio-video-camera/audio-device-information-properties.md) 
...
####### [Portieren des GLSL-Codes](gaming/port-the-glsl.md)
...
##### [Maximieren des Umsatzes mit einer Anzeigenvermittlung](monetize/use-ad-mediation-to-maximize-revenue.md)
...
### [Aktualisieren Ihres UWP-Projekts von der RC-Version auf die RTM-Version von Microsoft Visual Studio 2015](porting/update-your-visual-studio-2015-rc-project-to-rtm.md)
...
#### [Entsperren mit einem Begleitgerät](security/companion-device-unlock.md)
...
## [Dienste](https://dev.windows.com/en-us/develop/microsoft-services)
...
# [Veröffentlichen von Windows-Apps](https://dev.windows.com/en-us/publish)
...
## [App-Einreichungen](publish/app-submissions.md)
