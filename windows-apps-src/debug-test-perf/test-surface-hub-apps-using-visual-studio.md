...
Weitere Informationen finden Sie unter [Ausführen von Windows Store-Apps im Simulator](https://msdn.microsoft.com/en-us/library/hh441475.aspx).
...
4. Führen Sie Ihre App im Visual Studio-Simulator aus. Klicken Sie in der Palette auf die Schaltfläche **Change Resolution**, und wählen Sie in der Liste eine Surface Hub-Konfiguration aus.
   ...
   > **Tipp**&nbsp;&nbsp;[Schalten Sie den Tablet-Modus ein](http://windows.microsoft.com/en-us/windows-10/getstarted-like-a-tablet), um das Verhalten auf einem Surface Hub besser zu simulieren.
...
1. Öffnen Sie im Menü **Start** des Surface Hub die Einstellungs-App.
...
Weitere Informationen finden Sie unter [Bereitstellen und Debuggen von Apps für die universelle Windows-Plattform (UWP)](https://msdn.microsoft.com/en-us/windows/uwp/debug-test-perf/deploying-and-debugging-uwp-apps).
