...
Debuggen und testen Sie Ihre App mit Microsoft Visual Studio. Bereiten Sie Ihre App mithilfe des Zertifizierungskits für Windows-Apps auf den Windows Store-Zertifizierungsprozess vor.
...
| [Betatests](beta-testing.md) | **Betatests** bieten Ihnen die Möglichkeit, Ihre App anhand des Feedbacks von Personen außerhalb Ihres App-Entwicklungsteams zu verbessern, die die noch nicht freigegebene App auf ihren eigenen Geräten testen. |
...
| [Zertifizierungskit für Windows-Apps](windows-app-certification-kit.md) | Um optimale Voraussetzungen zum Zertifizieren der App zu schaffen, überprüfen Sie die App mit dem [Zertifizierungskit für Windows-Apps](http://go.microsoft.com/fwlink/p/?LinkID=309666). |
| [Leistung](performance-and-xaml-ui.md) | Benutzer erwarten, dass ihre Apps zuverlässig und reibungslos funktionieren und den Akku nicht übermäßig beanspruchen. Technisch gesehen ist die Leistung keine funktionale Anforderung. Wenn Sie die Leistung aber als Feature behandeln, hilft es Ihnen dabei, die Erwartungen der Benutzer zu erfüllen. Das Festlegen von Zielen und deren Messung sind wichtige Faktoren. Ermitteln Sie die für Sie leistungskritischen Szenarien, und legen Sie fest, was unter guter Leistung zu verstehen ist. Messen Sie die Ziele dann während des gesamten Lebenszyklus Ihres Projekts frühzeitig und häufig, damit Sie zuversichtlich sind, Ihre Ziele zu erreichen. |
