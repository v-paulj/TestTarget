...
-   Das Bild wird durch Festlegung von [**Opacity**](https://msdn.microsoft.com/library/windows/apps/BR208962) auf 0 oder [**Visibility**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.uielement.visibility) auf **Collapsed** für das Hostbildelement, den Pinsel oder ein beliebiges übergeordnetes Element ausgeblendet.
