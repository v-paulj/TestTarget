...
Für jedes Gerät gelten spezielle Anweisungen zum Herstellen der Verbindung mit dem Geräteportal, diese allgemeinen Schritte sind jedoch für jedes Gerät erforderlich.
1. Aktivieren Sie den Entwicklermodus und das Geräteportal auf Ihrem Gerät.
...
Telefon | Im Entwicklermodus aktivieren | 80| 443 | localhost:10080
...
- [Geräteportal für mobile Geräte](device-portal-mobile.md#setup)
...
- **Install app**: Wählen Sie in einem Ordner auf dem Computer oder im Netzwerk App-Pakete für die Installation aus.
- **Abhängigkeit**: Hier fügen Sie Abhängigkeiten für die zu installierende App hinzu.
- **Deploy**: Zum Bereitstellen der ausgewählten App und Abhängigkeiten auf Ihrem Gerät.
...
5.  Klicken Sie unter „Deploy“ auf „Los“. 
...
Aktivieren Sie „Hide Providers“, um nur die Liste der Ereignisse anzuzeigen.
- **Registered providers**: Wählen Sie den ETW-Anbieter und die Ablaufverfolgungsebene aus. Für die Ablaufverfolgungsebene wird einer der folgenden Werte festgelegt:
...
Klicken oder tippen Sie auf „Aktivieren“, um die Ablaufverfolgung zu starten. Der Anbieter wird der Liste „Enabled Providers“ hinzugefügt.
- **Custom providers**: Wählen Sie einen benutzerdefinierten ETW-Anbieter und die Ablaufverfolgungsebene aus. Identifizieren Sie den Anbieter anhand seiner GUID. Fügen Sie keine Klammern in die GUID ein.
...
- **Providers history**: Zeigt die ETW-Anbieter an, die während der aktuellen Sitzung aktiviert wurden. Klicken oder tippen Sie auf „Aktivieren“, um einen Anbieter zu aktivieren, der deaktiviert war. Klicken oder tippen Sie auf „Löschen“, um den Verlauf zu löschen.
- **Ereignisse**: Listet-ETW-Ereignisse der ausgewählten Anbieter im Tabellenformat auf. Diese Tabelle wird in Echtzeit aktualisiert. Klicken Sie unter der Tabelle auf die Schaltfläche „Löschen“, um alle ETW-Ereignisse aus der Tabelle zu löschen. Hierdurch werden keine Anbieter deaktiviert. Sie können auf „Speichern“ klicken, um die derzeit erfassten ETW-Ereignisse in eine lokale CSV-Datei zu exportieren.
...
- **Available profiles**: Wählen Sie in der Dropdownliste das WPR-Profil aus, und klicken oder tippen Sie auf „Starten“, um die Überwachung zu starten.
- **Custom profiles**: Klicken oder tippen Sie auf „Durchsuchen“, um ein WPR-Profil vom PC auszuwählen. Klicken oder tippen Sie auf „Upload and start“, um die Überwachung zu starten.

Zum Beenden der Überwachung klicken Sie auf den Link „Beenden“. Lassen Sie diese Seite geöffnet, bis der Download der Ablaufverfolgungsdatei („.etl“) abgeschlossen ist.
...
- **Available networks**: Die auf dem Gerät verfügbaren WLAN-Netzwerke.  Durch Klicken oder Tippen auf ein Netzwerk können Sie eine Verbindung mit ihm herstellen und ggf. ein Kennwort eingeben.  Hinweis: Das Geräteportal unterstützt noch keine Unternehmensauthentifizierung. 
