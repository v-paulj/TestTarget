...
-   [**Double**](https://msdn.microsoft.com/library/windows/apps/xaml/system.double.aspx) kann mit jeder beliebigen [**DoubleAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243136) animiert werden.
-   [**Point**](https://msdn.microsoft.com/library/windows/apps/BR225870) kann mit jeder beliebigen [**PointAnimation**](https://msdn.microsoft.com/library/windows/apps/BR210346) animiert werden.
-   [**Color**](https://msdn.microsoft.com/library/windows/apps/Hh673723) kann mit jeder beliebigen [**ColorAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243066) animiert werden.
...
`Duration="0:0:1"` gibt die Dauer der Animation an, also die Geschwindigkeit, mit der das Rechteck verblasst. Eine [ **Duration** ](https://msdn.microsoft.com/library/windows/apps/BR243207)-Eigenschaft wird in der Form *Stunden*:*Minuten*:*Sekunden* angegeben. Die Zeitdauer in diesem Beispiel beträgt eine Sekunde.
...
**Hinweis**  Wenn Sie im gezeigten Beispiel sicher sind, dass der Startzustand des animierten Objekts für [**Opacita**](https://msdn.microsoft.com/library/windows/apps/BR208962) immer den Wert 1 aufweist (entweder per Standardfestlegung oder expliziter Festlegung), können Sie den **From**-Wert weglassen. Die Animation verwendet dann den impliziten Startwert, und das Ergebnis ist dasselbe.
