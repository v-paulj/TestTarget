...
Von diesen Werten werden Sie für UI-Szenarien höchstwahrscheinlich [**TranslateTransform**](https://msdn.microsoft.com/library/windows/apps/BR243027) und [**ScaleTransform**](https://msdn.microsoft.com/library/windows/apps/BR242940) am häufigsten verwenden.
...
-   [
              **Brush.Transform**
            ](https://msdn.microsoft.com/library/windows/apps/BR228082), [**Brush.RelativeTransform**](https://msdn.microsoft.com/library/windows/apps/BR228080): Beeinflussen, wie ein [**Brush**](https://msdn.microsoft.com/library/windows/apps/BR228076)-Element den Koordinatenraum innerhalb des Bereichs verwendet, auf den das **Brush**-Element angewendet wird, um visuelle Eigenschaften (z. B. Vorder- und Hintergründe) festzulegen. Diese Transformationen sind für die meisten gängigen Brush-Elemente (mit denen normalerweise mit [**SolidColorBrush**](https://msdn.microsoft.com/library/windows/apps/BR242962) Volltonfarben festgelegt werden) zwar nicht relevant, sie können jedoch beim Zeichnen in Bereichen mit einem [**ImageBrush**](https://msdn.microsoft.com/library/windows/apps/BR210101)- oder [**LinearGradientBrush**](https://msdn.microsoft.com/library/windows/apps/BR210108)-Element nützlich sein.
-   [
              **Geometry.Transform**
            ](https://msdn.microsoft.com/library/windows/apps/BR210066): Sie können diese Eigenschaft zum Anwenden einer Transformation auf ein geometrisches Objekt anwenden, bevor dieses geometrische Objekt für einen [**Path.Data**](https://msdn.microsoft.com/library/windows/apps/BR243356)-Eigenschaftswert verwendet wird.
