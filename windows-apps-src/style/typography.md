...
Generell empfiehlt sich eine linksbündige Ausrichtung visueller Elemente und Spalten mit Schrift. In den meisten Fällen sorgt das Konzept „links bündig, rechts mit Flatterrand“ für eine konsistente Verankerung des Inhalts und für ein einheitliches Layout.
...
<figure class="figure-img" >
    <img src="images/type-ramp.png" alt="Shows the type ramp"  />
        <figcaption>Die Größe ist jeweils in effektiven Pixeln angegeben. Ausführlichere Informationen finden Sie unter „TODO: link“.</figcaption>
</figure>
